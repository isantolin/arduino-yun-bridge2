...
# Target: OpenWrt 25.12.3 (APK System)
#
...
# [CONFIG] Target Final OpenWrt 25.12.3
OPENWRT_VERSION=${1:-"25.12.3"}
...
# ==============================================================================
# [FIX CRITICO] Breaking Kconfig Recursive Dependencies (SDK 25.12.3)
# ==============================================================================
