...
_TOPIC_AUTH_MAPPING: Final[dict[tuple[str, str], str]] = {
    (Topic.FILE.value, FileAction.ACT_READ.value): "file_read",
    (Topic.FILE.value, FileAction.ACT_WRITE.value): "file_write",
    (Topic.FILE.value, FileAction.ACT_REMOVE.value): "file_remove",
    (Topic.DATASTORE.value, DatastoreAction.ACT_GET.value): "datastore_get",
    (Topic.DATASTORE.value, DatastoreAction.ACT_PUT.value): "datastore_put",
    (Topic.MAILBOX.value, MailboxAction.ACT_READ.value): "mailbox_read",
    (Topic.MAILBOX.value, MailboxAction.ACT_WRITE.value): "mailbox_write",
    (Topic.SHELL.value, ShellAction.ACT_RUN_ASYNC.value): "shell_run_async",
    (Topic.SHELL.value, ShellAction.ACT_POLL.value): "shell_poll",
    (Topic.SHELL.value, ShellAction.ACT_KILL.value): "shell_kill",
    (Topic.CONSOLE.value, ConsoleAction.ACT_IN.value): "console_input",
    (Topic.CONSOLE.value, ConsoleAction.ACT_INPUT.value): "console_input",
    (Topic.DIGITAL.value, DigitalAction.ACT_WRITE.value): "digital_write",
    (Topic.DIGITAL.value, DigitalAction.ACT_READ.value): "digital_read",
    (Topic.DIGITAL.value, DigitalAction.ACT_MODE.value): "digital_mode",
    (Topic.ANALOG.value, AnalogAction.ACT_WRITE.value): "analog_write",
    (Topic.ANALOG.value, AnalogAction.ACT_READ.value): "analog_read",
}
