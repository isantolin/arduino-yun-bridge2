...
def throttle(cache, count, seconds, name=..., expire=..., tag=..., time_func=..., sleep_func=...):
...
def barrier(cache, lock_factory, name=..., expire=..., tag=...):
...
def memoize_stampede(cache, expire, name=..., typed=..., tag=..., beta=..., ignore=...):
