...
4. Absolute Suppression Ban: Suppressions of any kind (warnings, lint, errors, or checks) are strictly prohibited, with the sole exception of autogenerated code, which may be suppressed. If any other suppressions are found in the codebase, they must be removed immediately.
