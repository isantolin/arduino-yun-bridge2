...
def test_supervise_task_exits_cleanly(
    ...
    async def _run() -> None:
        caplog.set_level(logging.WARNING, logger="mcubridge.supervisor")
...
def test_supervise_task_fatal_exception(
    ...
    async def _run() -> None:
        caplog.set_level(logging.CRITICAL, logger="mcubridge.supervisor")
...
def test_supervise_task_restarts_on_failure(
    ...
    async def _run() -> None:
        caplog.set_level(logging.ERROR, logger="mcubridge.supervisor")
