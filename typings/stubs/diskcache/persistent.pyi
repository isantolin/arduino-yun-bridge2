...
class Index(MutableMapping):
    ...
    def peekitem(self, last=...): # -> tuple[tuple[bytes | Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None], Any | None, Any] | tuple[tuple[bytes | Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None], Any | None] | tuple[tuple[bytes | Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None], Any] | tuple[bytes | Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None]:
    ...
    def pull(self, prefix=..., default=..., side=...): # -> tuple[Any, None, None] | tuple[Any, None] | tuple[tuple[Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None], Any | None, Any] | tuple[tuple[Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None], Any | None] | tuple[tuple[Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None], Any] | tuple[Any, bytes | Any | BufferedReader[_BufferedReaderStream] | str | None]:
    ...
    def keys(self): # -> KeysView[bytes | Any | None]:
    ...
    def values(self): # -> ValuesView[tuple[Any | None, None, None] | tuple[Any | None, None] | Any | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | None]:
    ...
    def items(self): # -> ItemsView[bytes | Any | None, tuple[Any | None, None, None] | tuple[Any | None, None] | Any | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | None]:
