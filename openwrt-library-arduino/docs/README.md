...
- Cada sketch debe definir `BRIDGE_SERIAL_SHARED_SECRET` (por ejemplo `#define BRIDGE_SERIAL_SHARED_SECRET "changeme123"`) antes de incluir `Bridge.h`; ese valor debe coincidir con `YUNBRIDGE_SERIAL_SECRET` en el daemon.
