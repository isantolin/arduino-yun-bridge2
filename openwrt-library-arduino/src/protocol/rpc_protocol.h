...
constexpr uint8_t RPC_HANDSHAKE_HKDF_SALT[] = {
    0x6D, 0x63, 0x75, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2D, 0x76, 0x32};
constexpr size_t RPC_HANDSHAKE_HKDF_SALT_LEN = 12;
constexpr uint8_t RPC_HANDSHAKE_HKDF_INFO_AUTH[] = {
    0x68, 0x61, 0x6E, 0x64, 0x73, 0x68, 0x61,
    0x6B, 0x65, 0x2D, 0x61, 0x75, 0x74, 0x68};
