---
name: gemini-plan-execute
description: Executes an approved plan of action using Gemini CLI within GitHub Actions workflows. Use when implementing code changes after maintainer approval.
---
