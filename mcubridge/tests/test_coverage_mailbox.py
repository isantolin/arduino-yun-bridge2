...
async def test_handle_push_overflow(mailbox_comp: MailboxComponent):
    ...
    mailbox_comp.state.mailbox_incoming_queue.append.return_value = type("Event", (), {"success": False})()
...
async def test_handle_outgoing_overflow(mailbox_comp: MailboxComponent):
    ...
    mailbox_comp.state.mailbox_queue.append.return_value = type("Event", (), {"success": False})()
