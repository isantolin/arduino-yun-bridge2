...
void test_bridge_coverage() {
  ...
  rpc::Frame f_unknown = {};
  f_unknown.envelope.command_id = 999;
  ...
  rpc::Frame f_ver = {};
  f_ver.envelope.command_id = (uint16_t)rpc::CommandId::CMD_GET_VERSION;
  f_ver.envelope.sequence_id = 1;
  ba.dispatch(f_ver);
  ba.dispatch(f_ver);  // Duplicate

  (void)Bridge.send(rpc::CommandId::CMD_GET_VERSION_RESP, 0, rpc_pb_VersionResponse_fields, []() {
  ...
  rpc::Frame f_pin = {};
  f_pin.envelope.command_id = (uint16_t)rpc::CommandId::CMD_DIGITAL_READ;
  bridge::test::set_pb_payload(f_pin, rpc_pb_PinRead_fields, []() {
    rpc_pb_PinRead p;
    p.pin = 255;
    return p;
  }());  // Invalid pin
  ...
  f_pin.envelope.payload.size = 0;  // Malformed
  ba.dispatch(f_pin);

  rpc::Frame f_dw = {};
  f_dw.envelope.command_id = (uint16_t)rpc::CommandId::CMD_DIGITAL_WRITE;
  bridge::test::set_pb_payload(f_dw, rpc_pb_DigitalWrite_fields, []() {
  ...
  rpc::Frame f_aw = {};
  f_aw.envelope.command_id = (uint16_t)rpc::CommandId::CMD_ANALOG_WRITE;
  bridge::test::set_pb_payload(f_aw, rpc_pb_AnalogWrite_fields, []() {
  ...
  rpc::Frame f_pm = {};
  f_pm.envelope.command_id = (uint16_t)rpc::CommandId::CMD_SET_PIN_MODE;
  bridge::test::set_pb_payload(f_pm, rpc_pb_PinMode_fields, []() {
    rpc_pb_PinMode p;
    p.pin = 13;
    p.mode = 1;
    return p;
  ...
  rpc::Frame f_cw = {};
  f_cw.envelope.command_id = (uint16_t)rpc::CommandId::CMD_CONSOLE_WRITE;
  bridge::test::set_pb_payload(f_cw, rpc_pb_ConsoleWrite_fields, cmsg);
  ba.dispatch(f_cw);
  ...
  rpc::Frame f_dsg = {};
  f_dsg.envelope.command_id =
      (uint16_t)rpc::CommandId::CMD_DATASTORE_GET_RESP;
  bridge::test::set_pb_payload(f_dsg, rpc_pb_DatastoreGetResponse_fields, ds_get_p);
  ba.dispatch(f_dsg);
  ...
  rpc::Frame f_mp = {};
  f_mp.envelope.command_id = (uint16_t)rpc::CommandId::CMD_MAILBOX_PUSH;
  bridge::test::set_pb_payload(f_mp, rpc_pb_MailboxPush_fields, mpush);
  ba.dispatch(f_mp);
  ...
  rpc::Frame f_mr = {};
  f_mr.envelope.command_id =
      (uint16_t)rpc::CommandId::CMD_MAILBOX_READ_RESP;
  bridge::test::set_pb_payload(f_mr, rpc_pb_MailboxReadResponse_fields, mread);
  ba.dispatch(f_mr);
  ...
  rpc::Frame f_ma = {};
  f_ma.envelope.command_id =
      (uint16_t)rpc::CommandId::CMD_MAILBOX_AVAILABLE_RESP;
  bridge::test::set_pb_payload(f_ma, rpc_pb_MailboxAvailableResponse_fields, mavl);
  ba.dispatch(f_ma);
  ...
  rpc::Frame f_sc = {};
  f_sc.envelope.command_id = (uint16_t)rpc::CommandId::CMD_SPI_SET_CONFIG;
  bridge::test::set_pb_payload(f_sc, rpc_pb_SpiConfig_fields, spi_cfg);
  ba.dispatch(f_sc);
#endif
  ...
  rpc::Frame f_fr = {};
  f_fr.envelope.command_id = (uint16_t)rpc::CommandId::CMD_FILE_READ_RESP;
  bridge::test::set_pb_payload(f_fr, rpc_pb_FileReadResponse_fields, fr_p);
  ba.dispatch(f_fr);

  rpc::Frame f_fw = {};
  f_fw.envelope.command_id = (uint16_t)rpc::CommandId::CMD_FILE_WRITE;
  rpc_pb_FileWrite fwp;
  strncpy(fwp.path, "test.txt", sizeof(fwp.path));
  rpc::payload::copy_to_pb_bytes(fwp.data, ds_val, 2);
  bridge::test::set_pb_payload(f_fw, rpc_pb_FileWrite_fields, fwp);
  ba.dispatch(f_fw);

  rpc::Frame f_flr = {};
  f_flr.envelope.command_id = (uint16_t)rpc::CommandId::CMD_FILE_READ;
  rpc_pb_FileRead frp;
  strncpy(frp.path, "test.txt", sizeof(frp.path));
  bridge::test::set_pb_payload(f_flr, rpc_pb_FileRead_fields, frp);
  ba.dispatch(f_flr);

  rpc::Frame f_frm = {};
  f_frm.envelope.command_id = (uint16_t)rpc::CommandId::CMD_FILE_REMOVE;
  rpc_pb_FileRemove frmp;
  strncpy(frmp.path, "test.txt", sizeof(frmp.path));
  bridge::test::set_pb_payload(f_frm, rpc_pb_FileRemove_fields, frmp);
  ba.dispatch(f_frm);
  ...
  rpc::Frame f_pk = {};
  f_pk.envelope.command_id = (uint16_t)rpc::CommandId::CMD_PROCESS_KILL;
  bridge::test::set_pb_payload(f_pk, rpc_pb_ProcessKill_fields, pk);
  ba.dispatch(f_pk);
  ...
  rpc::Frame f_prar = {};
  f_prar.envelope.command_id =
      (uint16_t)rpc::CommandId::CMD_PROCESS_RUN_ASYNC_RESP;
  bridge::test::set_pb_payload(f_prar, rpc_pb_ProcessRunAsyncResponse_fields, prar);
  ba.dispatch(f_prar);
  ...
  rpc::Frame f_ppr = {};
  f_ppr.envelope.command_id =
      (uint16_t)rpc::CommandId::CMD_PROCESS_POLL_RESP;
  bridge::test::set_pb_payload(f_ppr, rpc_pb_ProcessPollResponse_fields, ppr_p);
  ba.dispatch(f_ppr);
  ...
  lsync.tag.size = 16;
  rpc::Frame f_ls = {};
  f_ls.envelope.command_id = (uint16_t)rpc::CommandId::CMD_LINK_SYNC;
  bridge::test::set_pb_payload(f_ls, rpc_pb_LinkSync_fields, lsync);
  ba.dispatch(f_ls);

  rpc::Frame f_lr = {};
  f_lr.envelope.command_id = (uint16_t)rpc::CommandId::CMD_LINK_RESET;
  bridge::test::set_pb_payload(f_lr, rpc_pb_HandshakeConfig_fields, []() {
  ...
  rpc::Frame f_cap = {};
  f_cap.envelope.command_id =
      (uint16_t)rpc::CommandId::CMD_GET_CAPABILITIES;
  ba.dispatch(f_cap);

  rpc::Frame f_xoff = {};
  f_xoff.envelope.command_id = (uint16_t)rpc::CommandId::CMD_XOFF;
  ba.dispatch(f_xoff);

  rpc::Frame f_xon = {};
  f_xon.envelope.command_id = (uint16_t)rpc::CommandId::CMD_XON;
  ba.dispatch(f_xon);

  rpc::Frame f_eb = {};
  f_eb.envelope.command_id = (uint16_t)rpc::CommandId::CMD_ENTER_BOOTLOADER;
  bridge::test::set_pb_payload(f_eb, rpc_pb_EnterBootloader_fields, []() {
    rpc_pb_EnterBootloader p;
    p.magic = rpc::BOOTLOADER_MAGIC;
    return p;
  }());
  ba.dispatch(f_eb);

  rpc::Frame f_sb = {};
  f_sb.envelope.command_id = (uint16_t)rpc::CommandId::CMD_SET_BAUDRATE;
  bridge::test::set_pb_payload(f_sb, rpc_pb_SetBaudratePacket_fields, []() {
