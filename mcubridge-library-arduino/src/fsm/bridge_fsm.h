...
class StateUnsynchronized
    : public etl::fsm_state<BridgeFsm, StateUnsynchronized, STATE_UNSYNCHRONIZED,
...
class StateReady : public etl::fsm_state<BridgeFsm, StateReady, STATE_READY, EvReset, EvCryptoFault> {
 public:
  etl::fsm_state_id_t on_event(const EvReset&) { return STATE_UNSYNCHRONIZED; }
  etl::fsm_state_id_t on_event(const EvCryptoFault&) { return STATE_FAULT; }
  etl::fsm_state_id_t on_event_unknown(const etl::imessage&) { return No_State_Change; }
...
class StateIdle
    : public etl::fsm_state<BridgeFsm, StateIdle, STATE_IDLE, EvSendCritical, EvReset, EvCryptoFault> {
 public:
...
class StateFault : public etl::fsm_state<BridgeFsm, StateFault, STATE_FAULT, EvReset, EvCryptoFault> {
 public:
  etl::fsm_state_id_t on_event(const EvReset&) { return STATE_UNSYNCHRONIZED; }
