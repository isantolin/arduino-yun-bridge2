...
from ..core import CallbackFunc, CallbacksArg, Machine, ModelParameter, StateConfig, StateIdentifier, TransitionConfig
from .nesting import HierarchicalMachine
from typing import Any, Callable, Dict, List, Optional, Sequence, Type, TypedDict, Union
...
def rep(func: Union[CallbackFunc, str, Enum], format_references: Optional[Callable[[CallbackFunc], str]] = ...) -> str:
    ...
