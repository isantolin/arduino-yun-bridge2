...
SERIAL_HANDSHAKE_TAG_ALGORITHM: str = (
    rpc_protocol.HANDSHAKE_TAG_ALGORITHM
)
SERIAL_HANDSHAKE_TAG_DESCRIPTION: str = (
    rpc_protocol.HANDSHAKE_TAG_DESCRIPTION
)
SERIAL_HANDSHAKE_CONFIG_FORMAT: str = (
    rpc_protocol.HANDSHAKE_CONFIG_FORMAT
)
SERIAL_HANDSHAKE_ACK_TIMEOUT_MIN_MS: int = (
    rpc_protocol.HANDSHAKE_ACK_TIMEOUT_MIN_MS
)
SERIAL_HANDSHAKE_ACK_TIMEOUT_MAX_MS: int = (
    rpc_protocol.HANDSHAKE_ACK_TIMEOUT_MAX_MS
)
SERIAL_RESPONSE_TIMEOUT_MIN_MS: int = (
    rpc_protocol.HANDSHAKE_RESPONSE_TIMEOUT_MIN_MS
)
SERIAL_RESPONSE_TIMEOUT_MAX_MS: int = (
