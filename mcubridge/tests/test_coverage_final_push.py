...
@pytest.mark.asyncio
async def test_file_component_edge_cases(
    mock_config: Any, mock_state: Any, mock_serial_flow: Any, mock_mqtt_flow: Any
) -> None:
...
@pytest.mark.asyncio
async def test_handshake_service_edge_cases(
    mock_config: Any, mock_state: Any, mock_serial_flow: Any, mock_mqtt_flow: Any
) -> None:
    timing = SerialTimingWindow(
        ack_timeout_ms=100, response_timeout_ms=200, retry_limit=3
    )
...
@pytest.mark.asyncio
async def test_file_component_large_write(
    mock_config: Any, mock_state: Any, mock_serial_flow: Any, mock_mqtt_flow: Any
) -> None:
    file_comp = FileComponent(mock_config, mock_state, mock_serial_flow, mock_mqtt_flow)
