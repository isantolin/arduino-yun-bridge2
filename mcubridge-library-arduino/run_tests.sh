...
CFLAGS="-std=c++17 -O0 -g -DBRIDGE_HOST_TEST=1 -DBRIDGE_TEST_NO_GLOBALS=1 -DUNITY_INCLUDE_DOUBLE -DWOLFSSL_USER_SETTINGS -DBRIDGE_ENABLE_SPI=1 -Isrc -Isrc/wolfssl -Isrc/nanopb -Isrc/protocol -Itests/Unity -I../tools/arduino_stub/include"
