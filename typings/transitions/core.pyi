...
from typing import Any, Callable, Collection, DefaultDict, Deque, Dict, Iterable, List, Literal, Optional, OrderedDict, Required, Sequence, Tuple, Type, TypedDict, Union
...
class State:
    ...
    def __init__(self, name: Union[str, Enum], on_enter: CallbacksArg = ..., on_exit: CallbacksArg = ..., ignore_invalid_triggers: bool = ..., final: bool = ...) -> None:
        ...
...
class Transition:
    ...
    def __init__(self, source: str, dest: str, conditions: Optional[Condition] = ..., unless: CallbacksArg = ..., before: CallbacksArg = ..., after: CallbacksArg = ..., prepare: CallbacksArg = ...) -> None:
        ...
...
TransitionConfigList = Union[List[str], List[Sequence[str]], List[Optional[str]], List[Union[str, Enum]], List[Optional[Union[str, Enum]]]]
...
class EventData:
    ...
    def __init__(self, state: Optional[State], event: Optional[Event], machine: Machine, model: object, args: Iterable[Any], kwargs: Dict[str, Any]) -> None:
        ...
...
class Machine:
    ...
    def add_state(self, states: Union[Sequence[StateConfig], StateConfig], on_enter: CallbacksArg = ..., on_exit: CallbacksArg = ..., ignore_invalid_triggers: Optional[bool] = ..., **kwargs: Any) -> None:
        ...
    ...
    def add_ordered_transitions(self, states: Optional[Sequence[Union[str, State]]] = ..., trigger: str = ..., loop: bool = ..., loop_includes_initial: bool = ..., conditions: Optional[Sequence[Union[Callback, None]]] = ..., unless: Optional[Sequence[Union[Callback, None]]] = ..., before: Optional[Sequence[Union[Callback, None]]] = ..., after: Optional[Sequence[Union[Callback, None]]] = ..., prepare: CallbacksArg = ..., **kwargs: Any) -> None:
        ...
    
    def get_transitions(self, trigger: str = ..., source: StateIdentifier = ..., dest: StateIdentifier = ...) -> List[Transition]:
        ...
