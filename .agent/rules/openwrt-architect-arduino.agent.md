...
4. Absolute Suppression Ban: Suppressions of any kind are strictly prohibited; specifically, all warnings MUST be treated as errors, and "Pokemon" exceptions (catch-all) are forbidden, with the sole exception of autogenerated code, which may be suppressed. If any other suppressions are found in the codebase (Including "Pokemon" exceptions like try...except: pass), they must be removed immediately.
