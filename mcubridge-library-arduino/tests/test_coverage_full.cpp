...
void test_bridge_coverage() {
  ...
  rpc::Frame f_unknown = {};
  f_unknown.envelope.pb_msg.command_id = 999;
  ...
  rpc::Frame f_ver = {};
  f_ver.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_GET_VERSION;
  f_ver.envelope.pb_msg.sequence_id = 1;
  ba.dispatch(f_ver);
  ...
  rpc::Frame f_pin = {};
  f_pin.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_DIGITAL_READ;
  ...
  f_pin.envelope.pb_msg.payload.size = 0;  // Malformed
  ba.dispatch(f_pin);

  rpc::Frame f_dw = {};
  f_dw.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_DIGITAL_WRITE;
  ...
  rpc::Frame f_aw = {};
  f_aw.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_ANALOG_WRITE;
  ...
  rpc::Frame f_pm = {};
  f_pm.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_SET_PIN_MODE;
  ...
  rpc::Frame f_cw = {};
  f_cw.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_CONSOLE_WRITE;
  ...
  rpc::Frame f_dsg = {};
  f_dsg.envelope.pb_msg.command_id =
  ...
  rpc::Frame f_mp = {};
  f_mp.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_MAILBOX_PUSH;
  ...
  rpc::Frame f_mr = {};
  f_mr.envelope.pb_msg.command_id =
  ...
  rpc::Frame f_ma = {};
  f_ma.envelope.pb_msg.command_id =
  ...
  rpc::Frame f_sc = {};
  f_sc.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_SPI_SET_CONFIG;
  ...
  rpc::Frame f_fr = {};
  f_fr.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_FILE_READ_RESP;
  bridge::test::set_pb_payload(f_fr, fr_p);
  ba.dispatch(f_fr);

  rpc::Frame f_fw = {};
  f_fw.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_FILE_WRITE;
  ...
  rpc::Frame f_flr = {};
  f_flr.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_FILE_READ;
  ...
  rpc::Frame f_frm = {};
  f_frm.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_FILE_REMOVE;
  ...
  rpc::Frame f_pk = {};
  f_pk.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_PROCESS_KILL;
  ...
  rpc::Frame f_prar = {};
  f_prar.envelope.pb_msg.command_id =
  ...
  rpc::Frame f_ppr = {};
  f_ppr.envelope.pb_msg.command_id =
  ...
  rpc::Frame f_ls = {};
  f_ls.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_LINK_SYNC;
  bridge::test::set_pb_payload(f_ls, lsync);
  ba.dispatch(f_ls);

  rpc::Frame f_lr = {};
  f_lr.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_LINK_RESET;
  ...
  rpc::Frame f_cap = {};
  f_cap.envelope.pb_msg.command_id =
      (uint16_t)rpc::CommandId::CMD_GET_CAPABILITIES;
  ba.dispatch(f_cap);

  rpc::Frame f_xoff = {};
  f_xoff.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_XOFF;
  ba.dispatch(f_xoff);

  rpc::Frame f_xon = {};
  f_xon.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_XON;
  ba.dispatch(f_xon);

  rpc::Frame f_eb = {};
  f_eb.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_ENTER_BOOTLOADER;
  ...
  rpc::Frame f_sb = {};
  f_sb.envelope.pb_msg.command_id = (uint16_t)rpc::CommandId::CMD_SET_BAUDRATE;
