...
def test_queues_normalize_limit_with_string() -> None:
    ...
    from yunbridge.state.queues import _normalize_limit
...
def test_bounded_deque_iterator() -> None:
    ...
    from yunbridge.state.queues import BoundedByteDeque
...
def test_spool_disk_queue_initialization_failure() -> None:
    ...
    with patch("yunbridge.mqtt.spool.SqliteDeque", side_effect=OSError("Permission denied")):
        spool = MQTTPublishSpool(
...
async def test_bridge_snapshot_loop_exception() -> None:
    ...
    from yunbridge.metrics import _emit_bridge_snapshot
    from yunbridge.state.context import create_runtime_state
...
def test_normalize_interval_zero() -> None:
    ...
    from yunbridge.metrics import _normalize_interval
...
def test_sanitize_metric_name_leading_digit() -> None:
    ...
    from yunbridge.metrics import _sanitize_metric_name
