...
class Client:
    ...
    def disconnect(self, reasoncode: Any = None, properties: Properties | None = None) -> int: ...
    def subscribe(self, topic: str | list[tuple[str, int]], qos: int = 0, **kwargs: Any) -> tuple[int, int]: ...
    def publish(
        self,
        topic: str,
