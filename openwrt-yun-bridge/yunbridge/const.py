...
2.  **Protocol Mirroring**: Re-exports of `rpc.protocol` constants to decouple the application layer
    from the auto-generated protocol bindings.
3.  **Environment Variables**: Names of environment variables used for overrides.

Layers:
- `yunbridge.rpc.protocol`: Generated byte-level contract (Source of Truth).
- `yunbridge.const`: Application defaults and alias layer.
...
# ==============================================================================
# SECTION 1: RPC PROTOCOL MIRRORING (Layer 2 -> Layer 1)
# ==============================================================================
# These constants are aliases to the generated protocol definitions.
# We re-export them here to provide a single import point for the daemon logic
# and to allow for potential adaptation layers if the protocol changes.
...
DEFAULT_SERIAL_SAFE_BAUD: int = rpc_protocol.DEFAULT_SAFE_BAUDRATE
...
# ==============================================================================
# SECTION 2: APPLICATION DEFAULTS (Layer 2)
# ==============================================================================
