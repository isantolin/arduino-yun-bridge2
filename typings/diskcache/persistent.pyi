...
class Deque(Sequence):
    ...
    @classmethod
    def fromcache(cls, cache, iterable=..., maxlen=...):
...
class Index(MutableMapping):
    ...
    def push(self, value, prefix=..., side=...):
    ...
    def pull(self, prefix=..., default=..., side=...):
    ...
    def memoize(self, name=..., typed=..., ignore=...):
