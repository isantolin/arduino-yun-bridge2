---
name: gemini-invoke
description: Runs the Gemini CLI for autonomous software engineering tasks within GitHub Actions workflows. Use when planning and formulating development tasks via Gemini CLI.
---
