...
PROCESS_POLL_HEADER_SIZE: Final[int] = 6

ERROR_REASON_SERIAL_RX_OVERFLOW: Final[str] = "serial_rx_overflow"
ERROR_REASON_INTERNAL_ERROR: Final[str] = "Internal Error"
ERROR_REASON_DATA_GET_SHORT: Final[str] = "data_get_short"
ERROR_REASON_DATA_GET_KEY: Final[str] = "data_get_key"
ERROR_REASON_DATASTORE_QUEUE_FULL: Final[str] = "datastore_queue_full"
ERROR_REASON_PROCESS_RUN_PAYLOAD_TOO_LARGE: Final[str] = "process_run_payload_too_large"
ERROR_REASON_PROCESS_RUN_ASYNC_PAYLOAD_TOO_LARGE: Final[str] = "process_run_async_payload_too_large"
ERROR_REASON_PROCESS_POLL_QUEUE_FULL: Final[str] = "process_poll_queue_full"
ERROR_REASON_PROCESS_LIMIT_REACHED: Final[str] = "process_limit_reached"
ERROR_REASON_PROCESS_RUN_INTERNAL_ERROR: Final[str] = "process_run_internal_error"
ERROR_REASON_COMMAND_VALIDATION_FAILED: Final[str] = "command_validation_failed"
ERROR_REASON_PROCESS_RUN_ASYNC_FAILED: Final[str] = "process_run_async_failed"
ERROR_REASON_INVALID_PATH: Final[str] = "invalid_path"
ERROR_REASON_WRITE_LIMIT_EXCEEDED: Final[str] = "write_limit_exceeded"
ERROR_REASON_STORAGE_QUOTA_EXCEEDED: Final[str] = "storage_quota_exceeded"
ERROR_REASON_WRITE_FAILED: Final[str] = "write_failed"
ERROR_REASON_READ_FAILED: Final[str] = "read_failed"
ERROR_REASON_REMOVE_FAILED: Final[str] = "remove_failed"
ERROR_REASON_UNSAFE_PATH: Final[str] = "unsafe_path"
ERROR_REASON_DATASTORE_MISS: Final[str] = "datastore-miss"
