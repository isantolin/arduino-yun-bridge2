...
void test_bridge_handshake() {
  ...
  size_t len = rpc::serialize_frame(rpc::build_envelope(rpc::to_underlying(rpc::CommandId::CMD_LINK_SYNC), 1, etl::span<const uint8_t>(pl_buf.data(), pbos.bytes_written), frame_nonce, tag), etl::span<uint8_t>(frame_raw));
...
void test_bridge_process_rx() {
  ...
  size_t len = rpc::serialize_frame(rpc::build_envelope(rpc::to_underlying(rpc::CommandId::CMD_DIGITAL_WRITE), 10, etl::span<const uint8_t>(pl_buf.data(), pbos.bytes_written), frame_nonce, frame_tag), etl::span<uint8_t>(frame_raw));
...
void test_bridge_dedup_console_write() {
  ...
  size_t len = rpc::serialize_frame(rpc::build_envelope(rpc::to_underlying(rpc::CommandId::CMD_CONSOLE_WRITE), 55, etl::span<const uint8_t>(pl_buf.data(), pbos.bytes_written), frame_nonce, frame_tag), etl::span<uint8_t>(frame_raw));
...
void test_bridge_status_ack() {
  ...
  size_t len = rpc::serialize_frame(rpc::build_envelope(rpc::to_underlying(rpc::StatusCode::STATUS_ACK), 77, etl::span<const uint8_t>(pl_buf.data(), pbos.bytes_written), frame_nonce, frame_tag), etl::span<uint8_t>(frame_raw));
