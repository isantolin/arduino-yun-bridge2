...
class DjangoCache(BaseCache):
    ...
    def add(self, key, value, timeout=..., version=..., read=..., tag=..., retry=...):
    ...
    def get(self, key, default=..., version=..., read=..., expire_time=..., tag=..., retry=...):
    ...
    def set(self, key, value, timeout=..., version=..., read=..., tag=..., retry=...):
    ...
    def touch(self, key, timeout=..., version=..., retry=...):
    ...
    def pop(self, key, default=..., version=..., expire_time=..., tag=..., retry=...):
    ...
    def delete(self, key, version=..., retry=...):
    ...
    def incr(self, key, delta=..., version=..., default=..., retry=...):
    ...
    def decr(self, key, delta=..., version=..., default=..., retry=...):
    ...
    def memoize(self, name=..., timeout=..., version=..., typed=..., tag=..., ignore=...):
